...
const plan={name:'法国本科直申',label:'高中毕业后9–10月入学',items:[
...
['高二暑假','参加TCF/DELF/DALF等认可的法语考试；申请前建议取得B2及以上成绩；文学、人文社科、法律、翻译及语言类方向建议达到C1','最终确定申请院校及专业；完成文书素材表，整理专业背景、留学规划、简历CV、推荐信及已有实习/科研证明；进入Études en France/DAP等相应申请流程'],
['高三上10–12月','保持法语学习，根据院校要求冲刺B2–C1；⚠️ 最晚出成绩提醒：建议正式申请季前取得目标院校要求的B2/C1成绩，如仍未达标，需提前确认是否允许后补语言成绩；同步备战高考','完成动机信、简历CV、推荐信及材料补充，按时递交本科申请；高考成绩参考：巴黎地区500+、其他地区400+（满分750）；跟进Campus France相关流程'],
['高三下1–3月','根据目标院校要求继续提升法语，冲刺C1；同步备战高考','跟进审核，并按要求完成Campus France相关流程/面试；准备说明留学目的、专业兴趣、升学规划及院校认知；等待院校审核结果'],
['高三下4–5月','保持法语能力，加强学术法语；同步备战高考','陆续获得院校申请结果；确定最终入学院校；完成录取确认及后续入学准备'],
['高三下6–7月','持续提升法语能力，为法国本科课程做准备','完成高中毕业及最终材料准备；启动签证及入学手续；落实住宿等赴法事项'],
['8–10月','加强生活法语及学术法语，做好本科课程衔接；进入法国后的法语及专业课程学习','办理签证并完成行前指导；准备住宿、机票、保险等事项；完成赴法前准备并报到注册；正式进入法国本科']
]};
