...
['大二下','春季周末/晚班：韩语T2，180课时，每周6-10小时；暑假全日制：韩语T3，180课时','积累实习、科研及竞赛背景；初步确定院校与专业方向'],
['大三上','秋季周末/晚班：韩语T4，180课时，每周6-10小时；寒假接触TOPIK题型','建立院校梯度；核对语言及申请要求；规划TOPIK考试'],
['大三下','春季周末/晚班：韩语T5，180课时，每周6-10小时；暑假全日制：韩语T6，180课时；强化TOPIK训练','确定目标院校及专业；梳理文书、成绩单及申请材料'],
['大四上','TOPIK II集中备考，120课时，每周6-10小时；参加考试并持续刷分','最终定校定专业；完成文书及申请材料；关注春季申请开放时间']
];
const masterPlans={
direct:{name:'春季3月入学',label:'毕业次年3月',items:[...masterFromD2,
['大四下4-7月','参加TOPIK II考试；根据成绩安排刷分；争取目标语言等级','确定春季申请方案及院校；准备网申与基础材料'],
['毕业当年8-11月','按院校要求继续TOPIK刷分或补充语言成绩','完成网申及材料递交；跟进审核、面试与补件'],
