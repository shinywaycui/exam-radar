...
['语言学校期间6月','参加第一次EJU考试；以试水和熟悉题型为主','参加赴日后第一次EJU；检验当前水平；等待成绩公布'],
['8–10月','按首次EJU成绩查漏补缺；继续日语及留考刷分','获取首次EJU成绩；参加大学校内考并查看结果；按结果调整备考重点'],
['11–12月','参加第二次EJU；出分后准备名校冲刺','11月参加第二次EJU；12月获取考试成绩；根据成绩报名冲刺院校'],
['1–2月','针对目标大学强化校内考及面试','参加大学校内考及面试；跟进考试结果'],
...
['大三上','秋季周末/晚班：日语N2，180课时，每周6–8小时；目标5000–7000词/200条语法；寒假巩固','提升专业及科研背景；确定匹配教授及申请方向；开始准备研究计划书'],
['大三下','春季周末/晚班：日语N1，180课时，每周6–8小时；7月JLPT N1；暑期托福目标85+','6月确定修士申请及语言方案；7月申请语言学校并参加面试；获得语言学校合格通知'],
['大四上','持续巩固日语N1；托福备考及刷分；12月建议参加JLPT考试','完善研究计划书及备考规划；准备语言学校正式材料；了解目标大学院考试要求'],
['大四上1–2月','保持日语及专业课学习；按目标院校要求准备英语','开具语言学校纸质材料；递交入管局申请材料；申请在留资格'],
['大四下3–4月','持续学习日语；开始准备修士专业课及面试','等待入管局审核；准备本科毕业及赴日材料；完善研究计划书'],
...
['大三下暑期','保持日语及英语能力；按目标院校要求补充语言成绩','进行教授面试辅导；参加教授面试；争取获得教授内诺'],
['大四上+寒假','持续提升学术日语及专业英语能力','继续参加科研、实践或实习；完善研究计划书及材料；参加教授或研究科面试'],
