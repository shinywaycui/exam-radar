(function(){
  ...
  const masterItems=[
    ...
    {time:'大三上',tone:'decision',language:['秋季周末/晚班｜德语 B2｜240课时 · 每周6–10小时','寒假｜准备德福考试','参加3月德福考试'],apply:['确定最终院校及专业','规划APS审核时间与方式','确认GRE / GMAT要求']},
    {time:'大三下及暑假6–8月',tone:'apply',language:['德福备考｜160课时 · 集中学习','参加7月德福考试','按成绩安排后续刷分'],apply:['推进TestAS / APS面谈','按确认路径推进APS审核','准备硕士申请材料']},
    {time:'大四上9–10月',tone:'apply',language:['继续德福 / 歌德备考','参加11月德福考试','考出GRE / GMAT（如要求）'],apply:['补充所需学业材料','同步准备硕士申请']},
