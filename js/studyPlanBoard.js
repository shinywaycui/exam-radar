(function(){
  ...
  const masterItems=[
    ...
    {time:'大三上',tone:'decision',language:['秋季周末/晚班｜德语 B2｜240课时 · 每周6–10小时','寒假｜准备德福考试','参加3月德福考试'],apply:['规划APS时间与方式','继续确定院校梯度']},
    {time:'大三下及暑假6–8月',tone:'apply',language:['德福备考｜160课时 · 集中学习','参加7月德福考试','按成绩安排后续刷分'],apply:['初步确定院校梯度','推进TestAS / APS面谈']},
