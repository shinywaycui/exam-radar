(function(){
  ...
  const common=[
    ...
    {time:'高二下',tone:'language',language:['春季周末班｜德语 B2｜240课时','暑假全日制｜德福备考｜160课时','参加7月德福考试','考试｜B2 阶段考试｜取得证书']},
    {time:'高三 · 高考期',tone:'decision',language:['德福备考持续进行','参加11月或次年3月德福考试'],apply:['准备高考','准备申请材料'],detail:'审核材料通常约1个月'},
  ];
  const routeData={
    direct:{label:'高考成绩 ≥ 70%',title:'高考直申路径',summary:'达到高考满分70%，进入审核、语言达标与本科申请流程。',later:[
      ...
      {time:'9月—次年1月',tone:'apply',language:['继续冲刺德福考试','参加11月德福考试'],apply:['可选择国内继续学习','或先赴德国学习语言'],detail:'根据语言成绩选择方案'},
      {time:'次年4—7月',tone:'milestone',language:['参加7月德福考试','最低考出B2等级','德福通过后持续学习'],apply:['申请德国本科直入'],detail:'同步关注申请截止时间'},
  ...
  const masterItems=[
    ...
    {time:'大一下',tone:'language',language:['春季周末/晚班｜德语 A2｜240课时 · 每周6–10小时'],apply:['保持GPA并重视课程匹配','参加实习、竞赛或科研']},
    {time:'大二上',tone:'language',language:['秋季周末/晚班｜德语 B1｜180课时 · 每周6–10小时','寒假｜复习巩固'],apply:['先确定目标院校','确认GRE / GMAT要求']},
    {time:'大二下',tone:'language',language:['春季周末/晚班｜德语 B1+｜150课时 · 每周6–10小时','暑假｜复习巩固'],apply:['选专业课程','实习科研','评估TestAS / APS面谈路径']},
    {time:'大三上',tone:'decision',language:['秋季周末/晚班｜德语 B2｜240课时 · 每周6–10小时','寒假｜准备德福考试','参加3月德福考试'],apply:['规划APS时间与方式','选专业课程与实习']},
    {time:'大三下及暑假6–8月',tone:'apply',language:['德福备考｜160课时 · 集中学习','参加7月德福考试','按成绩安排后续刷分'],apply:['初步确定院校梯度','选专业课程与实习','推进TestAS / APS面谈']},
    {time:'大四上9–10月',tone:'apply',language:['继续德福 / 歌德备考','参加11月德福考试','考出GRE / GMAT（如要求）'],apply:['准备硕士申请材料','补充所需学业材料','同步准备硕士申请']},
    {time:'大四上10月–次年2月',tone:'apply',language:['语言未达标则继续刷分','参加11月德福考试'],apply:['按个人情况完成APS审核','取得APS审核证书','完善选校及申请方案']},
    {time:'大四下3–4月',tone:'apply',language:['准备德福 / 歌德考试','参加3月德福考试','冲刺最终语言成绩'],apply:['开具前7学期成绩单','完善硕士正式申请材料','确定最终院校及专业']},
    {time:'大四下5–7月',tone:'milestone',language:['冲刺目标院校语言要求','按院校政策补充语言成绩'],apply:['正式递交硕士申请','跟进院校审核及补件']},
  ...
  function studyPlan(state={country:'DE',route:'direct',scenario:'highschool'}){
    state.scenario=state.scenario||'highschool';if(state.country==='DE'&&state.scenario==='highschool')state.route='direct';const country=countries.find(x=>x[0]===state.country)||countries[0],route=routeData.direct,items=[...common,...route.later];
  ...
  window.UI.studyPlan=state=>{
    ...
    if(state?.country==='DE'&&state?.scenario==='highschool')html=html.replace('<section class="matrix-page">','<section class="matrix-page de-undergrad" style="--decols:9">');
    return html;
  };
})();
