(function(){
  ...
  const masterItems=[
    ...
    {time:'大二上',tone:'language',language:['秋季周末/晚班｜德语 B1｜180课时 · 每周6–10小时','寒假｜复习巩固'],apply:['先确定目标院校','选专业课程','实习科研','确认GRE / GMAT要求']},
    {time:'大二下',tone:'language',language:['春季周末/晚班｜德语 B1+｜150课时 · 每周6–10小时','暑假｜复习巩固'],apply:['初步确定院校梯度','评估TestAS / APS面谈路径']},
    {time:'大三上',tone:'decision',language:['秋季周末/晚班｜德语 B2｜240课时 · 每周6–10小时','寒假｜准备德福考试','参加3月德福考试'],apply:[]},
    {time:'大三下及暑假6–8月',tone:'apply',language:['德福备考｜160课时 · 集中学习','参加7月德福考试','按成绩安排后续刷分'],apply:['推进TestAS / APS面谈','按确认路径推进APS审核']},
